  ...
  return (
    <div className='child__form-input'>
      ...
      <select name="chilSelect" id="chilSelect">
        ...
        <option value="secondGrade">Second Grade</option><option value="thirdGrade">Third Grade</option><option value="fourthGrade">Fourth Grade</option><option value="fifthGrade">Fifth Grade</option>
